...
from parkhealth.settings import MEDIA_URL
from main.models import MedicalStaff, Specialty
...
def menu(section="", subsection="", bio=""):
    ...
    c = Context({ 'MEDIA_URL':MEDIA_URL, 'specialties':specialties, 
